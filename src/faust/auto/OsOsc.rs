...
impl OsOscSIG0 {
	...
	fn get_num_inputsOsOscSIG0(&self) -> i32 {
		return 0;
	}
	fn get_num_outputsOsOscSIG0(&self) -> i32 {
		return 1;
	}

	fn instance_initOsOscSIG0(&mut self, sample_rate: i32) {
		for l0 in 0..2 {
	...
	fn fillOsOscSIG0(&mut self, count: i32, table: &mut[F32]) {
		for i1 in 0..count {
			self.iVec0[0] = 1;
...
pub fn newOsOscSIG0() -> OsOscSIG0 {
	OsOscSIG0 {
		iVec0: [0;2],
		iRec0: [0;2],
	}
}
static mut ftbl0OsOscSIG0: [F32;65536] = [0.0;65536];
pub struct OsOsc {
	fHslider0: F32,
	fSampleRate: i32,
	fConst0: F32,
...
impl FaustDsp for OsOsc {
	...
	fn class_init(sample_rate: i32) {
		let mut sig0: OsOscSIG0 = newOsOscSIG0();
		sig0.instance_initOsOscSIG0(sample_rate);
		sig0.fillOsOscSIG0(65536, unsafe { &mut ftbl0OsOscSIG0 });
	}
	...
	fn compute(&mut self, count: i32, inputs: &[&[Self::T]], outputs: &mut[&mut[Self::T]]) {
		...
		for output0 in zipped_iterators {
			...
			*output0 = unsafe { ftbl0OsOscSIG0[(((65536.0 * self.fRec1[0]) as i32)) as usize] };
